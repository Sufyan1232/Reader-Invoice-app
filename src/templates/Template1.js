...
function Template1({name, age,  country,  passport, designation,salary, salaryw, company, comArabic, nationality, hrname, pobox, addrees, region,  date}) {
...
<div className='tim'> <img src={food} className='timg' width="100px" /><h3 className='title1'>{company} </h3> </div> 
<h3 className='title'>{company} </h3>
</div>
<h2 className='titlearabic'>مطعم نيو ديوان ميان جي ذ م م</h2>
