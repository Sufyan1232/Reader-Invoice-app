...
function Template10({name, age,  country,  passport, designation,salary, salaryw, company, comArabic, nationality, hrname, pobox, addrees, region,  date}) {
...
<div className='main3' >
    <img src={t10} width="1320px" height="250px"/>
